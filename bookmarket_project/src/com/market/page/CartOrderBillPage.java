...
public class CartOrderBillPage extends JPanel {
	...
	public CartOrderBillPage(JPanel panel, MemberVo orderMember, MainWindow main, CartDao cartDao) {
	...
	public void printCart(JPanel panel) {
		...
		ArrayList<CartVo> cartList = cartDao.select(orderMember.getMid().toUpperCase());
		int sum = 0;
